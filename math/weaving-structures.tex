...
The benchmark tables below are reserved for empirical comparisons of Alpha 1,
Alpha 2, and Alpha 3 on random binary targets. Rows list the algorithm, and
columns list the draft size \(p\times w\).

\begin{table}[ht]
  \centering
  \caption{Benchmark template for a standard 4-shaft loom with 4 shafts and 6
  treadles.}
  \label{tab:benchmark-four-shaft}
  \begin{tabular}{lcccc}
    \hline
    Algorithm & \(10\times10\) & \(20\times20\) & \(30\times30\) & \(40\times40\) \\
    \hline
    Alpha 1 & & & & \\
    Alpha 2 & & & & \\
    Alpha 3 & & & & \\
...
\begin{table}[ht]
  \centering
  \caption{Benchmark template for a standard 8-shaft loom with 8 shafts and 10
  treadles.}
